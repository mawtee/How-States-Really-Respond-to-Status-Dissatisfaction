...
capture log close
log using "Status Conflict among Small States\Data Analysis\Replication Files\Stata Log Files\01-Data Management\02-Controls & Components\a-Similarity\IGO Joint Membership\scss-0102a-simigo-c-comp",replace

* Programme: scss-0102a-simigo-c-comp.do
...
********************************************************************************************
* Generate yearly datasets with component variables for calculation of similarity measures *
********************************************************************************************

* Description *
***************
* This do-file generates the component variables for the calculation of three similarity measures - S-unweighted, Cohen's Kappa-unweighted and Scott's Pi-unweighted - using IGO joint membership decile ranks
...
foreach year of numlist 1949/2000 {
     ...
     /// Load directed dyadic igo dataset (socio-matrix) for the respective year
         use "Status Conflict among Small States\Data Analysis\Datasets\Derived\01-Data Management\02-Controls & Components\a-Similarity\IGO Joint Membership\b-Socio-Matrices\scss-0102a-simigo-b-smat-`year'.dta"  ,clear
	 ...
	 /// Define variables and generate dataset
		 ...
		 */ using "Status Conflict among Small States\Data Analysis\Datasets\Derived\01-Data Management\02-Controls & Components\a-Similarity\IGO Joint Membership\c-Similarity Components\scss-0102a-simigo-c-comp-`year'.dta" ,replace
	 ...
	 *~  Loop through all possible combinations of country pairs
		 ...
		 foreach country2 of local cabblist {
			  ...
			  **********************************************************
			  ...
			  /// Generate sum of variables values: sum(x) where x is the non-missing decile rank of the sum of IGO joints memberships between i and k where, and only where, there is a non-missing decile rank of the sum of IGO joint memberships between j and k
	...
	* Load and save dataset
	 *************** 
    /// Load dataset   
		use "Status Conflict among Small States\Data Analysis\Datasets\Derived\01-Data Management\02-Controls & Components\a-Similarity\IGO Joint Membership\c-Similarity Components\scss-0102a-simigo-c-comp-`year'.dta"  ,clear
	...
	/// Save
	    compress
	    save "Status Conflict among Small States\Data Analysis\Datasets\Derived\01-Data Management\02-Controls & Components\a-Similarity\IGO Joint Membership\c-Similarity Components\scss-0102a-simigo-c-comp-`year'.dta" ,replace
