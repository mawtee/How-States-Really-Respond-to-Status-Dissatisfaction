...
capture log close
log using "Status Conflict among Small States\Data Analysis\Replication Files\Stata Log Files\01-Data Management\02-Controls & Components\a-Similarity\Total Bilateral Trade\scss-0102a-simtbitr-c-comp",replace

* Programme: scss-0102a-simtbitr-c-comp.do
...
* Description *
***************
* This do-file generates the component variables for the calculation of three similarity measures - S-unweighted, Cohen's Kappa-unweighted and Scott's Pi-unweighted - using total bilateral trade decile ranks
...
foreach year of numlist 1949/2000 {
     ...
     /// Load directed dyadic igo dataset (socio-matrix) for the respective year
         use "Status Conflict among Small States\Data Analysis\Datasets\Derived\01-Data Management\02-Controls & Components\a-Similarity\Total Bilateral Trade\b-Socio-Matrices\scss-0102a-simtbitr-b-smat-`year'.dta", clear
	 ...
	 /// Define variables and generate dataset
		 ...
		 */ using "Status Conflict among Small States\Data Analysis\Datasets\Derived\01-Data Management\02-Controls & Components\a-Similarity\Total Bilateral Trade\c-Similarity Components\scss-0102a-simtbitr-c-comp-`year'.dta", replace
	 ...
	 *~  Loop through all possible combinations of country pairs
		 ...
		 foreach country2 of local cabblist {
			  ...
			  **********************************************************
			  ...
			  /// Generate sum of variable values: sum(X) where X is the non-missing decile rank of total bilateral trade between i and k where, and only where, there is a non-missing decile rank of total bilateral trade between j and k
   ...
   /// Load dataset   
		use "Status Conflict among Small States\Data Analysis\Datasets\Derived\01-Data Management\02-Controls & Components\a-Similarity\Total Bilateral Trade\c-Similarity Components\scss-0102a-simtbitr-c-comp-`year'.dta", clear
   ...
   /// Label variables
	...
	/// Save
	    compress
	    save "Status Conflict among Small States\Data Analysis\Datasets\Derived\01-Data Management\02-Controls & Components\a-Similarity\Total Bilateral Trade\c-Similarity Components\scss-0102a-simtbitr-c-comp-`year'.dta", replace
